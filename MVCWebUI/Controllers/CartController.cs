...
namespace MVCWebUI.Controllers
{
	public class CartController : Controller
	{
		...
		public IActionResult AddToCart(int productId)
		{
			...
			{
				TempData["Messasge"] = "Product can not be added to cart because there is no product in stock!";
		...
		public IActionResult ClearCart()
		{
			...
			// HttpContext.Session.Remove(SESSIONKEY); // bu key'e sahip sessionlar temizlenir
